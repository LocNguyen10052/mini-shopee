        ...
        <Fragment>
                ...
                <div className='nav-bar-container'>
                    <ul className="nav-bar">
                        <li className="nav-link-container">
                            <Link className="nav-link" to=''>
                                <span className="span-class">Kênh Người Bán</span>
                            </Link>
                        </li>
                        <li className="nav-link-container">
                        ...
                        <li className="nav-link-container">
                            <Link className="nav-link" to=''>
                                <span className="span-class">Trở thành Người bán Shopee</span>
                            </Link>
                        </li>
                        <li className="nav-link-container">
                            <span className="span-class">|</span>
                        ...
                        <li className="nav-link-container ">
                            <span className="nav-link" to=''>Kết nối</span>
                        </li>
                        <li className="nav-link-container ">
                            <span className="flex v-center r6OuTw nav-link">
                                <span className="flex j8v5Hs zLaik4 nav-link">
                                    <a className="L8d8QY header-navbar-background header-navbar-facebook-png nav-link" href="https://facebook.com/ShopeeVN" target="_blank" rel="noopener noreferrer" title="Kết nối Facebook"></a>
                                    <a href="https://instagram.com/Shopee_VN" target="_blank" rel="noopener noreferrer" className="nav-link Gd1Epy header-navbar-background header-navbar-instagram-png" title="Kết nối Instagram!"></a>
                                </span>
                            </span>
                        </li>
                    </ul>
                    <ul className="nav-bar">
                        ...
                        <li className="nav-link-container ">
                            ...
                            <span className="span-class">Tiếng Việt</span>
                        </li>
                        {userIsLoaded ?
                            (
                                <li className="nav-link-container ">
            ...
            <div className='search-box'>
                ...
                <div className="header-with-search__search-section">
                    <form role="search" autoComplete="off" className="shopee-searchbar">
                        <div className="shopee-searchbar__main">
                            <div className="shopee-searchbar-input">
                                <input aria-label="SALE MỪNG QUỐC KHÁNH" className="shopee-searchbar-input__input" maxLength="128" placeholder="SALE MỪNG QUỐC KHÁNH" autoComplete="off" aria-autocomplete="list" aria-controls="shopee-searchbar-listbox" aria-expanded="false" role="combobox" />
                            </div>
                        </div>
                        <button type="button" className="btn btn-solid-primary btn--s btn--inline shopee-searchbar__search-button">
                            <svg height="19" viewBox="0 0 19 19" width="19" className="shopee-svg-icon"><g fillRule="evenodd" stroke="none" strokeWidth="1">
